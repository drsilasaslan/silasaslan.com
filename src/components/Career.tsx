...
const careerItems = [
  {
    ...
    role: "Prokurist – Innovationsmanager AI & Scouting",
    company: "SWK-NOVATEC GmbH",
    description:
      "KI-Transformation, Enablement, Governance und strategisches Scouting für die Stadtwerke Karlsruhe.",
    highlight: true,
  },
  {
    period: "Apr 2023 – Feb 2025",
    role: "Projektmanager Innovation (AI & Scouting)",
    company: "SWK-NOVATEC GmbH",
    description:
      "KI-Integration, DSGVO-konforme Evaluation, Use-Case-Identifikation und interne Formate.",
  },
  {
    ...
    company: "OTONGO.net",
    description:
      "KI-natives Experiment: Agentenorganisation, lokale Modelle, ruhige Technologie im Betrieb.",
    highlight: true,
  },
  {
    ...
    company: "otego GmbH",
    description: "Lab-Aufbau, Materialentwicklung, Skalierung des Teams von 4 auf 12.",
    highlight: true,
  },
  {
    period: "2014 – 2018",
        ...
        >
              ...
              >
                ...
                <div
                  className={`absolute left-0 md:left-1/2 top-1 w-3 h-3 rounded-full transform md:-translate-x-1/2 ${
                    item.highlight ? "bg-[var(--primary)]" : "bg-[var(--muted-light)]"
                  }`}
                />

                {/* Content */}
                <div
                  className={`${item.highlight ? "bg-[var(--surface-alt)] p-6 rounded-lg" : ""}`}
                >
                  <p className="text-sm text-[var(--primary)] mb-1">{item.period}</p>
                  <h3 className="text-lg font-medium text-[var(--foreground)] mb-1">{item.role}</h3>
          ...
          >
            <p className="text-sm text-[var(--muted)]">
              <span className="text-[var(--accent)]">Auszeichnung:</span> Gewinner &ldquo;Elevator
              Pitch BW&rdquo; Regional Cup Karlsruhe
            </p>
          </motion.div>
        </motion.div>
      </div>
