...
const pageTitle = "Datenschutz | Hackathon";
const pageDescription = "Datenschutzerklärung für die Hackathon-Seite.";
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "Datenschutz",
      item: `${siteUrl}/hackathon/datenschutz/`,
    },
  ],
};
...
const webPageData = {
  "@type": "WebPage",
  "@id": `${siteUrl}/hackathon/datenschutz/#webpage`,
  url: `${siteUrl}/hackathon/datenschutz/`,
  name: pageTitle,
...
export const metadata: Metadata = {
  ...
  description: pageDescription,
  alternates: {
    canonical: "/hackathon/datenschutz/",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
        ...
        <div className="hackathon-container">
          ...
          <div className="hackathon-card mt-6 space-y-6 text-[var(--hack-muted)]">
            ...
            <section className="space-y-3">
              ...
              <h4 className="font-semibold text-[var(--hack-ink)]">Wie erfassen wir Ihre Daten?</h4>
              <p>
              ...
              <h4 className="font-semibold text-[var(--hack-ink)]">Wofür nutzen wir Ihre Daten?</h4>
              <p>
            ...
            <section className="space-y-3">
              ...
              <p>
                ...
                Website erfasst werden, werden auf den Servern des Hosters gespeichert. Dabei kann
