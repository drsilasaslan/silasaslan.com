      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            ...
            <h3 className="text-lg font-medium text-[var(--foreground)] mt-6 mb-3">Datenschutz</h3>
            <p className="text-[var(--muted)] leading-relaxed">
            ...
            <p className="text-[var(--muted)] leading-relaxed">
              ...
              werden. Sofern Sie in die Speicherung von Cookies oder in den Zugriff auf
          ...
          {/* 5. Soziale Medien */}
          <section>
            <h2 className="text-xl font-medium text-[var(--foreground)] mb-4">5. Soziale Medien</h2>
            ...
            <p className="text-[var(--muted)] leading-relaxed">
              ...
              XING eingebunden. Beim Klick auf diese Links werden Sie auf die entsprechenden
              ...
              personenbezogenen Daten bei Nutzung dieser Websites entnehmen Sie bitte den jeweiligen
