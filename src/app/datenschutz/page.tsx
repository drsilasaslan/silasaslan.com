...
const pageTitle = "Datenschutzerklärung | Dr. Silas Aslan";
const pageDescription = "Datenschutzerklärung gemäß DSGVO";
...
const webPageData = {
  "@type": "WebPage",
  "@id": `${siteUrl}/datenschutz/#webpage`,
    ...
    <>
      ...
      <div className="min-h-screen bg-[var(--surface)]">
        ...
        <main className="max-w-4xl mx-auto px-6 py-16">
          <h1 className="text-3xl font-light text-[var(--foreground)] mb-8">
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-[var(--muted)] leading-relaxed">
                ...
                Kontaktdaten können Sie dem Abschnitt &ldquo;Hinweis zur Verantwortlichen
            ...
            {/* 2. Hosting */}
            <section>
              <h2 className="text-xl font-medium text-[var(--foreground)] mb-4">2. Hosting</h2>
              <p className="text-[var(--muted)] leading-relaxed">
            ...
            <section>
              ...
              <p className="text-[var(--muted)] leading-relaxed">
                ...
                verarbeitet werden. Sofern Sie in die Speicherung von Cookies oder in den Zugriff
                auf Informationen in Ihr Endgerät eingewilligt haben, erfolgt die Datenverarbeitung
            ...
            <section>
              ...
              <h3 className="text-lg font-medium text-[var(--foreground)] mt-6 mb-3">Cookies</h3>
              <p className="text-[var(--muted)] leading-relaxed">
            ...
            <section>
              ...
              <p className="text-[var(--muted)] leading-relaxed">
                Auf dieser Website sind lediglich Verlinkungen zu sozialen Netzwerken wie LinkedIn
                und XING eingebunden. Beim Klick auf diese Links werden Sie auf die entsprechenden
                externen Seiten weitergeleitet. Erst beim Besuch dieser externen Seiten werden Daten
                an die jeweiligen Anbieter übertragen. Informationen zum Umgang mit Ihren
                personenbezogenen Daten bei Nutzung dieser Websites entnehmen Sie bitte den
            ...
            <section>
              ...
              <p className="text-[var(--muted)] leading-relaxed">
                ...
                Fonts, die lokal installiert sind. Eine Verbindung zu Servern von Google findet
                dabei nicht statt.
              </p>
            </section>
          </div>
          ...
          {/* Last updated */}
          <p className="mt-8 text-sm text-[var(--muted-light)]">Stand: Dezember 2024</p>
        </main>
      </div>
    </>
  );
