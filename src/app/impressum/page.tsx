...
const pageTitle = "Impressum | Dr. Silas Aslan";
const pageDescription = "Impressum und Angaben gemäß § 5 TMG";
      ...
      <div className="min-h-screen bg-[var(--surface)]">
        ...
        <main className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-medium text-[var(--foreground)] mb-4">Kontakt</h2>
              <p className="text-[var(--muted)] leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-medium text-[var(--foreground)] mb-4">Urheberrecht</h2>
              <p className="text-[var(--muted)] leading-relaxed">
